...
class __TwigTemplate_f94b74f247a49f082a68306b58d121a6 extends Template
{
        ...
        if (($context["stores"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["store"]) {
              ...
              <td>";
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["store"], "store_id", [], "any", false, false, false, 17) == 0)) {
                    yield " <strong>(";
  ...
  <div class=\"row\">
    ...
    {
        return new Source("<form id=\"form-store\" method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"{{ action }}\" data-oc-target=\"#list\">
  <div class=\"table-responsive\">
    <table class=\"table table-bordered table-hover\">
      <thead>
        <tr>
        ...
        {% if stores %}
          {% for store in stores %}
            <tr>
              ...
              <td>{{ store.name }}{% if store.store_id == 0 %} <strong>({{ text_default }})</strong>{% endif %}</td>
              <td>{{ store.url }}</td>
...
</form>", "admin/view/template/setting/store_list.twig", "C:\\xampp\\htdocs\\opencart\\admin\\view\\template\\setting\\store_list.twig");
    }
}
